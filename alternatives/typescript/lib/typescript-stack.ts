    ...
    NagSuppressions.addResourceSuppressions(this.authnFnSecretsManagerPolicy, [
      {
        ...
        reason:
          "API is resource agnostic but resource key required in statement.",
      },
    ]);
      ...
      [
        {
          ...
          reason:
            "Construct specific: Enabling log retention creates a separate Lambda Function with managed policy.",
        },
      ],
    );
